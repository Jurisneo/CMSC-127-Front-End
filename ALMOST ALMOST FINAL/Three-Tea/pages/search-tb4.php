    ...
    <body>
        ...
        <section class="table">
            <div class="tableTitle">
				<h1>SEARCH RESULTS - Room Table</h1>
			</div>
            ...
            <div class="table-wrap">
                <table>
                    ...
                    <?php
                        if (isset($_POST['searchtb4'])) {
                            $tb4search = $_POST['tb4-search'];

                            $query = "SELECT Rm_ID, Rm_Name, Rm_Bldg 
                                    FROM ROOM 
                                    WHERE CONCAT(Rm_ID, Rm_Name, Rm_Bldg)
                                    LIKE '%".$tb4search."%'";
