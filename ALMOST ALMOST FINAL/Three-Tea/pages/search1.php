...
<html>
    ...
    <body>
        <nav class="navBar">
            ...
            <div class="navIcons">
                <a href="filter.php"><i class='bx bx-arrow-back'></i></a>
                    ...
                    <?php
                        if (isset($_POST['search1'])) {
                            ...
                            $queryCheck = "SELECT STUDENT.Stud_Num, STUDENT.Stud_LastName, COURSE.Crs_Name, INSTRUCTOR.Ins_LastName, ROOM.Rm_Name, ROOM.Rm_Bldg, CHECKLIST.CList_SemTaken, CHECKLIST.CList_AcadYear
                                        ...
                                        WHERE CONCAT(STUDENT.Stud_Num, STUDENT.Stud_LastName, COURSE.Crs_Name, INSTRUCTOR.Ins_LastName, ROOM.Rm_Name, ROOM.Rm_Bldg, CHECKLIST.CList_SemTaken, CHECKLIST.CList_AcadYear)
                                        LIKE '%".$valueToSearch."%'";
