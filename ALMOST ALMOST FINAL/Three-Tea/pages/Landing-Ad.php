...
<html>
    ...
    <body>
        <nav class="navBar">
            ...
            <div class="navLinks">
                <ul>
                    <li><a href="Landing-Ad.php" class="active">HOME</a></li>
            ...
            <div class="landing-content">
                <div class="landing-card">
                    <div class="card-content">
                        ...
                        <div class="card-btn">
                            <button class="chkBtn" onclick="location.href='tb1.php'">CHECKLIST</button>
                    </div>
                </div>
            </div>
            ...
            <div class="landing-content">
                <div class="landing-card">
                    <div class="card-content">
                        ...
                        <div class="card-btn">
                            <button class="crsBtn" onclick="location.href='tb2.php'">COURSES</button>
                    </div>
                </div>
            </div>
            ...
            <div class="landing-content">
                <div class="landing-card">
                    <div class="card-content">
                        ...
                        <div class="card-btn">
                            <button class="insBtn" onclick="location.href='tb3.php'">INSTRUCTORS</button>
                    </div>
                </div>
            </div>
            ...
            <div class="landing-content">
                <div class="landing-card">
                    <div class="card-content">
                        ...
                        <div class="card-btn">
                            <button class="rmBtn" onclick="location.href='tb4.php'">ROOMS</button>
                    </div>
                </div>
            </div>
            ...
            <div class="landing-content">
                <div class="landing-card">
                    <div class="card-content">
                        ...
                        <div class="card-btn">
                            <button class="studBtn" onclick="location.href='tb5.php'">STUDENTS</button>
                    </div>
                </div>
            </div>
