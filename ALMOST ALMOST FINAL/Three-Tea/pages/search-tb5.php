...
<html>
    ...
    <body>
        <nav class="navBar">
            ...
            <div class="navIcons">
                <a href="tb5.php"><i class='bx bx-arrow-back'></i></a>
        ...
        <section class="table">
            <div class="tableTitle">
				<h1>SEARCH RESULTS - Student Table</h1>
			</div>
            ...
            <div class="table-wrap">
                <table>
                    ...
                    <?php
                        if (isset($_POST['searchtb5'])) {
                            $tb5search = $_POST['tb5-search'];

                            $query = "SELECT Stud_ID, Stud_Num, Stud_LastName, Stud_FirstName, Stud_MidName, Stud_Sex, Stud_Year, Stud_Email, Stud_PhoneNum 
                                    FROM STUDENT
                                    WHERE CONCAT(Stud_ID, Stud_Num, Stud_LastName, Stud_FirstName, Stud_MidName, Stud_Sex, Stud_Year, Stud_Email, Stud_PhoneNum)
                                    LIKE '%".$tb5search."%'";
