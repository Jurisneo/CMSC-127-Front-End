            ...
            <div class="tableTitle">
                ...
                <div class="mini-title2">
                    ...
                    <div class="search-bar">
                        <form action="search-tb2.php" method="POST">
                            <input id="search" type="text" name="tb2-search" placeholder="Filter Search">
                            <button type="submit" name="searchtb2">FILTER</button>
                        </form>
                    </div>
