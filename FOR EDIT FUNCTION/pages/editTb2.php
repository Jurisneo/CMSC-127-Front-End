                ...
                <form action="update.php" method="POST">
                    <div class="input">
                        <div class="inputDetails">
                            ...
                            <input type="number" name="crsID" pattern="[1][1][2][0-9]{2}" value="<?php echo $row['Crs_ID'];?>"required>
                        </div>
                    </div>
                <!-- first row of form -->
                    <div class="input">
                        <div class="inputDetails">
                            ...
                            <select name="crsCateg" value="<?php echo $row['Crs_Categ'];?>" required>
                ...
                <!-- second row of form -->
                    <div class="input">
                        <div class="inputDetails">
                            ...
                            <input type="text" name="crsName" value="<?php echo $row['Crs_Name'];?>" required>
                        </div>
                    </div>
                <!-- third row of form -->
                    <div class="input">
                        <div class="inputDetails">
                            ...
                            <input type="text" name="crsDesc" value="<?php echo $row['Crs_Descript'];?>" required>
                        </div>
                    </div>
                <!-- fourth row of form -->
                <div class="input">
                        <div class="inputDetails">
                            ...
                            <select name="crsComp" value="<?php echo $row['Crs_Comp'];?>" required>
                ...
                <!-- fifth row of form --> 
                    <div class="input">
                        <div class="inputDetails">
                            ...
                            <input type="text" name="crsPR" value="<?php echo $row['Crs_PreReq'];?>" required>
                        </div>
                    </div>
                <!-- sixth row of form -->
                    <div class="input">
                        <div class="inputDetails">
                            ...
                            <input type="number" name="crsUnits" max="5" value="<?php echo $row['Crs_Units'];?>" required>
                        </div>
                    </div>
                <!-- seventh row of form -->
                    <div class="input">
                        <div class="inputDetails">
                            ...
                            <select name="crsSem" value="<?php echo $row['Crs_Sem'];?>" required>
                    ...
                    <div class="input">
                        <div class="inputDetails">
                            ...
                            <select name="crsIns" value="<?php echo $row['Ins_ID'];?>" required>
                    ...
                    <div class="input">
                        <div class="inputDetails">
                            ...
                            <select name="crsRm" rvalue="<?php echo $row['Rm_ID'];?> "equired>
                                <option value="" disabled>--Choose Instructor--</option>
                    ...
                    <div class="edittb-btn">
                        <button type="submit" name="edittb-btn">UPDATE COURSE</button>
                    </div>
                </form>
            </div>
        </section>
