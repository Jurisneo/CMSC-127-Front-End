    ...
    <body>
        ...
        <section class="container">
            <div class="formBox">
                ...
                <form id="login" class="formGrp-stud">
                    <input type="text" name="username2" class="LSinput" placeholder="USERNAME" required>
                    <input type="password" name="password2" class="LSinput" placeholder="PASSWORD" minlength="5" required>
                    <div class="check">
                        <input type="checkbox" id="showPW1" name="showPW2" class="showPW" onclick="showPW()">
